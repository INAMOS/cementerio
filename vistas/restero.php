...
<div class="container">
    <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
            <form action="../action/reg_rest.php?ced=<?php echo $filas[0]['cedul_cadv']; ?>&id=<?php echo $_GET['id']?>" method="POST">
                <fieldset disabled>
                    <div class="form-group">
                        <label for="disabledTextInput">Cedula</label>
                        <input type="text" id="disabledTextInput" class="form-control"
                            placeholder="<?php echo $filas[0]["cedul_cadv"]; ?>">
                    </div>
                    <div class="form-group">
                        <label for="disabledTextInput">Nombres</label>
                        <input type="text" id="disabledTextInput" class="form-control"
                            placeholder="<?php echo $filas[0]["nombr_cadv"]. " " . $filas[0]["apell_cadv"] ; ?>">
                    </div>
                    <div class="form-group">
                        <label for="disabledTextInput">Fecha de Inhumacion</label>
                        <input type="text" id="disabledTextInput" class="form-control"
                            placeholder="<?php echo $filas[0]["fech_inhum"];  ?>">
                    </div>
                </fieldset>
                <div class="form-group">
